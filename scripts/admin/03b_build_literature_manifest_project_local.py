...
LITERATURE_ROOT = Path("/data2/lxj/projects/CervixAgent/data/literature")
OUTPUT_ROOT = Path(
    "/data2/lxj/projects/CervixAgent/manifests/literature_20260724_project_local"
)
EXPECTED_FILES = 2970
...
def main() -> int:
    ...
    csv_path = OUTPUT_ROOT / "literature_files_20260724_project_local.csv"
    ...
    summary_path = OUTPUT_ROOT / "literature_acceptance_20260724_project_local.json"
    ...
    checksum_path = OUTPUT_ROOT / "literature_manifest_20260724_project_local.sha256"
